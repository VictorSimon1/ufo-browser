...
await build({
  ...shared,
  entryPoints: ["src/main/native-cef-application.ts"],
  outfile: "dist/main/native-cef-application.js",
  platform: "node",
  format: "esm",
});
...
await build({
  ...shared,
  entryPoints: ["src/main/native-cef-presentation.ts"],
  outfile: "dist/main/native-cef-presentation.js",
  platform: "node",
  format: "esm",
});
...
await build({
  ...shared,
  entryPoints: ["src/main/native-cef-profile-sync.ts"],
  outfile: "dist/main/native-cef-profile-sync.js",
  platform: "node",
  format: "esm",
});
